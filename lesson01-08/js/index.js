        ...
        return <li className="list-group-item">
               {this.props.value}
                <div className="item-box right">
                    <a  href="javascript:void(0);" className="glyphicon glyphicon-edit" onClick={this.edit}></a>
...
const List = React.createClass({
    ...
    render(){
        ...
        for(let entity of this.state.list){
            listDOM.push(<Item id={entity[0]} key={entity[0]} onEdit={this.edit} onRemove={this.removeItem} vlaue={entity[1]}/>);
        }
